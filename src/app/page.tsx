    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-6">
	  ...
	  <a
        ...
        <div className="text-center text-xs text-[var(--text-secondary)] pt-2 opacity-60">
          Card data from <a href="https://scryfall.com" className="underline" target="_blank" rel="noopener noreferrer">Scryfall</a>. Popularity data from <a href="https://cubecobra.com" className="underline" target="_blank" rel="noopener noreferrer">CubeCobra</a>. Not affiliated with Wizards of the Coast. &bull; v0.63
        </div>
      </div>
    </main>
  );
