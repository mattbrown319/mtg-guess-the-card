    ...
    <html lang="en">
      <body className="min-h-screen flex flex-col">
        ...
        <footer className="text-center text-xs text-[var(--text-secondary)] py-4 px-6 opacity-60">
          Card data from <a href="https://scryfall.com" className="underline" target="_blank" rel="noopener noreferrer">Scryfall</a>. Not affiliated with Wizards of the Coast. &bull; v0.16
        </footer>
      </body>
    </html>
  );
